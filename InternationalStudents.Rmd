...
```{r FromTWNCountryMap,warning=F,message=F}
#讀取shapefile
worldMap<-readShapeSpatial("ne_110m_admin_0_countries/ne_110m_admin_0_countries.shp")
...
### 資料匯入與處理
```{r dataloadFromTWNAb,warning=F,message=F}
#讀取資料
#世界各主要國家之我國留學生人數統計表
...
### 台灣學生最喜歡去哪些國家留學面量圖
```{r FromTWNAbMap,warning=F,message=F}
#讀取shapefile
worldMap<-readShapeSpatial("ne_110m_admin_0_countries/ne_110m_admin_0_countries.shp")
...
根據圖表顯示:<br>
有境外學生來台的國家不一定有台灣學生前往，例如越南、印尼和澳門<br>
有台灣學生前往的國家也不一定有境外學生來台，例如西班牙、俄羅斯和捷克<br>
...
國家總數(有境外學生來台或台灣學生前往)：180個國家<br>
境外學生來台的國家總數：177個國家<br>
台灣學生前往的國家總數：82個國家<br>
有境外學生來台和台灣學生前往的國家總數：79個國家<br>
有境外學生來台的國家的比例：98%<br>
有台灣學生前往的國家的比例：46%<br>
有台灣學生前往和境外學生來台的國家的比例：44%<br>
根據以上數據，來台讀書與離台讀書的來源國與留學國趨勢不太相同，只有約44%的國家有台灣學生前往和境外學生來台<br>
...
根據表格顯示:<br>
有些國家的台灣學生前往的比例遠高於境外學生來台的比例，例如北韓的16、科威特的5.5<br>
有些國家的台灣學生前往的比例大約等於境外學生來台的比例，例如尼日和阿曼的1、柬埔寨的0.95<br>
...
根據表格顯示:<br>
很多國家的境外學生來台的比例遠高於台灣學生前往的比例，在前10名中的比例都達到了100以上<br>
所以想來台灣念書的境外生，他們母國的台籍生並不多<br>